  ...
  <c:remove var="errorMsg" scope="session" />
            ...
            <div class="card mt-5" >
                <div class="card-header" >
                            ...
                            <h3 class="text-center">vice_principle Login</h3>
                            <form Action="viceprinciplelogin" method="post">
                            
                            
                            
                             <div class="mb-3 mt-3">
                                    <label class=" mb-1">vice principle</label>
                                <select required class="form-control" name="depee">
                                 <option value="">---select---</option>
                                    <option value="navalsir">naval sir</option>
                                    <option value="kalesir">kale sir</option>
