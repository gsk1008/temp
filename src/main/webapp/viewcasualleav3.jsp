...
<%@include file="component/navebar.jsp" %>
 ...
 <div class="page-nav  row d-flex justify-content-center align-item-center mt-5 "  >
...
<thead >
                 <tr>
                     ...
                     <td><h5>Hod approvel</h5></td>
                     <td><h5>faculty incharge approvel</h5></td>
                     <td><h5>mam approvel</h5></td>
                     <td><h5>Action</h5></td>
                     <td><h5>Department</h5></td>
                         ...
                         List<cl_casual_teaching> list1=dao1.getccasualtupamam(td);
   ...
   <td>
     <% 
	  if("pending".equals(ap1.getTupe_approvel())){%>
		  <a href="mamcomment.jsp?id1=<%=ap1.getId()%>" class="btn btn-success btn-sm">commint</a>
	  <%}else{%>
