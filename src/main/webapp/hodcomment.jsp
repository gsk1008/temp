...
<%@include file="component/navebar.jsp" %>
 ...
 <div class="page-nav no-margin row d-flex justify-content-center align-item-center mt-5 " >
     ...
     <h5>comment</h5><br>
      ...
      <form action="hodupdate"  method="post">
      <tr>
             <td>
             <label>Full Name</label>        
        <input class="form-control" name="fullname" id="userName" type="text" 
        readonly value="<%=ap.getName() %>" >
      ...
      <tr>
      <td><input class="form-control" name="id"  id="email" type="hidden"  readonly value="<%=ap.getId() %>" >
      </tr>
                <tr>
      <td colspan="2">   
